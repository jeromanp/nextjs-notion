      ...
      <main className="h-full bg-crema justify-between p-12">
        <div className="container mx-auto">
          <div className="">
            ...
            <div className="flex items-center">
              <p className="text-xl text-black text-justify">
                Este proyecto llamado, "Notion to Next.js Page Generator," es
                una solución innovadora que aprovecha la potencia de Notion{" "}
                <span>
                  <svg
                ...
                para simplificar la creación de páginas web estáticas a partir
                del contenido que se gestiona en la plataforma Notion. <br />
                <br /> Con esta herramienta, hemos eliminado las barreras
                técnicas y brindamos a los usuarios la capacidad de transformar
                sus ideas, documentos y bases de datos en páginas web hermosas y
                funcionales de forma sencilla y eficiente.
                <br />
                <br />
                Por el momento contiene una sección Recetas y una seccion Blog,
                que reciben datos directamente desde la cuenta de Notion. Te
                invito a explorar este proyecto
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto my-5">
            <p className="text-xl text-black text-justify">
              Visita los siguientes links de contenido:
            </p>
            <div className="flex justify-center py-10">
              <Link href={"/recipes"}>
                <button
                  type=""
                  className="bg-cafe text-white rounded-lg p-2 mx-5 hover:bg-mostaza"
                >
                  Recetas
                </button>
              </Link>
